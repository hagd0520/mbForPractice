package com.ll.mbforpractice.global.initData;

import com.ll.mbforpractice.domain.book.book.entity.Book;
import com.ll.mbforpractice.domain.book.book.service.BookService;
...
import com.ll.mbforpractice.domain.member.member.service.MemberService;
import com.ll.mbforpractice.domain.product.cart.service.CartService;
import com.ll.mbforpractice.domain.product.product.entity.Product;
import com.ll.mbforpractice.domain.product.product.service.ProductService;
...
public class NotProd {
    ...
    public void work1() {
        ...
        memberService.addCash(memberUser1, 100_000, CashLog.EventType.충전__무통장입금);
        memberService.addCash(memberUser1, -20_000, CashLog.EventType.충전__통장입금);
